						  ...
						  <div id="sidebar1">
							...
							<table width="80%" border="0" align="center" class="sortable">
							  <tr>
								...
								<th width="7%" align="center" scope="col"><div align="center"><h5>Status</h5></div></th>
							  </tr>
		  <?php 
							
											   
		   $STMt = $dbh->prepare("SELECT * FROM tbl_mail, tbl_message WHERE tbl_mail.msgid = tbl_message.msgid AND (tbl_mail.msgto = '$sentby' OR tbl_mail.msgcc = '$sentby') AND status ='trash' ORDER BY tbl_message.msgdate DESC");

			$STMt->execute();

			$STMrecordst = $STMt->fetchAll();
			foreach($STMrecordst as $mailt)
			...
			<td align="left"><a href="replymsg.php?msgid=<?php echo $mailt['msgid'];?>"><img src="img/mail_reply.png" width="24" height="24" alt="reply" /></a></td>
			
			<td align="left"><a href="forwardmsg.php?msgid=<?php echo $mailt['msgid'];?>"><img src="img/mail_forward.png" width="24" height="24" alt="forward" /></a></td>
			
			<td align="left"><a href="delmsg.php?msgid=<?php echo $mailt['msgid'];?>"><img src="img/email_delete.png" width="28" height="28" alt="delete" /></a></td>

			<td align="left"><a href="#"><?php echo $mailt['sentby']; ?></a></td>

			<td align="left"><a href="javascript;:"onclick="MM_openBrWindow('readmsg.php?msgid=<?php echo $mailt['msgid'];?>','','scrollbars=yes,width=50%,height=auto');return false"><strong><?php echo $mailt['msubject'];?></strong></a></td>

			<td align="left"><a href="#"><?php echo $mailt['msgdate']; ?></a></td>

			<td align="center"><a href="#"><?php echo $mailt['status']; ?></a></td>
