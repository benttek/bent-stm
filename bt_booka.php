          ...
          <div class="features_area">
			...
			<div class="slider_content" style="align:center;">
				...
				<div class="table-responsive">
				  ...
				  <a href="bt_roomres.php?u=<?php echo $user;?>" class="" style="color: white;">  <i class="fa fa-calendar fa-4x"></i><br>                 
				   <h4>Booking</h4><br></a>
				  </td>
				  
				  <td align="center" width="50%">
				  <a href="bt_rm_srch.php?u=<?php echo $user;?>" class="" style="color: white;"><i class="fa fa-clock-o fa-4x"></i><br>                   
				   <h4>Booking (By Time)</h4><br></a>
				  </td>
					</tr>
				  <tr>
				  <td align="center" width="50%">
				  <a href="bt_my_bookings.php?user=<?php echo $user;?>" class="" style="color: white;"> <i class="fa fa-group fa-4x"></i><br>                  
				   <h4>My Bookings</h4></a>
				  </td>
				  
				  <td align="center" width="50%">
				  <a href="bt_mtg_chkin.php?u=<?php echo $user;?>" class="" style="color: white;"> <i class="fa fa-check-circle-o fa-4x"></i><br>                  
				   <h4>Check-In</h4></a>
					</td>
					</tr>
				</table>
