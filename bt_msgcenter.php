    ...
    <div class="container" style="background-color: #2d2d2d;">
        ...
        <div class="col-lg-12">
            ...
            <div class="features_responsive">
				...
				<div id="container">
						 <br><br><br>
							<p><a href="newmsg.php">New Message</a>&nbsp;&nbsp; |&nbsp;&nbsp; <a href="sentmsgs.php">Sent</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="msgtrash.php">Trash</a></p>
							<br>
							<table width="100%" border="0" align="center" class="sortable">
							  <tr>
								...
								?>
								<th width="" align="center" scope="col"><h5></h5></th>
								<th width="22%" align="left" scope="col"><h5>From</h5></th>
								<th width="50%" align="left" scope="col"><h5>Subject</h5></th>
								<th width="22%" align="right"><h5>Date</h5></th>
									
								<?php } else { ?>
								<th width="7%" align="left" scope="col"><h5>Reply</h5></th>
								<th width="7%" align="left" scope="col"><h5>Forward</h5></th>
								<th width="7%" align="left" scope="col"><h5>Delete</h5></th>
								<th width="15%" align="left" scope="col"><h5>From</h5></th>
		  ...
		  <?php 
		   ...
		   $STM1 = $dbh->prepare("SELECT * FROM tbl_mail, tbl_message WHERE tbl_mail.msgid = tbl_message.msgid AND (tbl_mail.msgto = '$sentby') AND status != 'trash' ORDER BY tbl_mail.status ASC, tbl_message.msgdate DESC");
			...
			<td align="left"><a href="trashmsg.php?msgid=<?php echo $mail['msgid'];?>&msgto=<?php echo $sentby;?>"><img src="img/email_delete.png" width="20" height="20" alt="delete" /></a></td>
			<td align="left"><a href="#" style="color:white;"><?php echo $mail['sentby']; ?></a></td>

			<td align="left"><a href="javascript;:"onclick="MM_openBrWindow('readmsg.php?msgid=<?php echo $mail['msgid'];?>','','scrollbars=yes,width=50%,height=auto');return false" style="color:white;"><?php echo $mail['msubject'];?></a></td>

			<td align="left"><a href="#" style="color:white;"><?php echo DATE("d-m", strtotime($mail['msgdate'])); ?></a></td>
			
			
			<?php } else {  ?>
			<td align="left"><a href="replymsg.php?msgid=<?php echo $mail['msgid'];?>"><img src="img/mail_reply.png" width="24" height="24" alt="reply" /></a></td>
			...
			<td align="left"><a href="trashmsg.php?msgid=<?php echo $mail['msgid'];?>&msgto=<?php echo $sentby;?>"><img src="img/email_delete.png" width="28" height="28" alt="delete" /></a></td>
			
			<td align="left"><a href="#"><?php echo $mail['sentby']; ?></a></td>
			...
			<?php } ?>
							...
							<p class="style6"><a href="bt_msgcenter.php" class="style2">Inbox</a></p>
